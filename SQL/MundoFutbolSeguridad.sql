CREATE OR REPLACE PACKAGE PC_admin IS
    ...
    PROCEDURE Add_seleccion(Nombre Selecciones.Nombre%TYPE,dirTecnico selecciones.dirtecnico%TYPE, Confederaciones_Siglas Selecciones.Confederaciones_Siglas%TYPE, Estadios_Nombre Selecciones.Estadios_Nombre%TYPE, Titulos Selecciones.Titulos%TYPE, Estadisticas Selecciones.Estadisticas%TYPE);
...
CREATE OR REPLACE PACKAGE BODY PC_admin AS
    ...
    PROCEDURE Add_seleccion(Nombre Selecciones.Nombre%TYPE,dirTecnico selecciones.dirtecnico%TYPE, Confederaciones_Siglas Selecciones.Confederaciones_Siglas%TYPE, Estadios_Nombre Selecciones.Estadios_Nombre%TYPE, Titulos Selecciones.Titulos%TYPE, Estadisticas Selecciones.Estadisticas%TYPE)
        IS
        BEGIN
            INSERT INTO Selecciones VALUES (Nombre,dirTecnico, Confederaciones_Siglas,Estadios_Nombre,Titulos,Estadisticas);
